  ...
  routes: [
    ...
    // ── Admin （需要登入）────────────────────────────────
    {
      ...
      children: [
        ...
        { path: 'inbound',           component: () => import('@/views/admin/InOutboundView.vue'),      meta: { title: '出入庫管理' } },
        { path: 'outbound',          redirect: '/admin/inbound' },
        ...
        { path: 'stores',            component: () => import('@/views/admin/StoresView.vue'),         meta: { title: '分店管理' } },
